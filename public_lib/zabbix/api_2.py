...
class _zabbix(object):
    ...
    def version(self):
        ...
        """
        self.base['params'] = []
        self.base['method'] = "apiinfo.version"
    ...
    def host_id_exists(self, *args, **kwargs):
        ...
        :param kwargs:
            hostid: host id
        """
        self.base['method'] = "host.exists"
        self.base['params'] = {"hostid": kwargs['hostid']}
        return self._req(data=self.base)
    ...
    def items_exists(self, *args, **kwargs):
        ...
        :return:
        """
        self.base['method'] = "item.exists"
        self.base['params'] = {"key_": kwargs.get('key_', ''),"hostid": kwargs['hostid']}
        return self._req(data=self.base)
    ...
    def items_create(self, *args, **kwargs):
        ...
        self.base['params'] = {
            ...
            "delay": kwargs.get('update',60),
            "history":kwargs.get('history', 60),
            "trends":kwargs.get('trends', 90),
    ...
    def interface_exists(self,*args,**kwargs):
        ...
        :return:
        """
        self.base['method'] = "hostinterface.exists"
        self.base['params'] = {"output": "extend","hostids": kwargs['hostid'],"ip": kwargs['ip']}
        return self._req(data=self.base)
    ...
    def screen_create(self, *args, **kwargs):
        ...
        self.base['params'] = {"name": kwargs['name'],"hsize": hsize,"vsize": vsize,"screenitems": Dict}
        return self._req(data=self.base)
    ...
    def screen_create_host(self, *args, **kwargs):
        ...
        """
        hostid = kwargs['hostid']
        if self.host_id_exists(hostid=hostid).get('result',False) is True:
    ...
    def group_exists(self, *args, **kwargs):
        ...
        """
        self.base['params'] = {"name": kwargs['name']}
        self.base['method'] = "hostgroup.exists"
        return self._req(data=self.base)
    ...
    def graph_hostid_exists(self, *args, **kwargs):
        ...
        """
        self.base['method'] = "graph.exists"
        self.base['params'] = {"name": kwargs['name'],"hostids": kwargs['hostid']}
        return self._req(data=self.base)
    ...
    def graph_hostname_exists(self, *args, **kwargs):
        ...
        """
        self.base['method'] = "graph.exists"
        self.base['params'] = {"name": kwargs['name'],"host": kwargs['host_name']}
        return self._req(data=self.base)
    ...
    def template_name_exists(self, *args, **kwargs):
        ...
        :param kwargs:
            :name: template name
        """
        self.base['method'] = "template.exists"
        self.base['params'] = {"host": kwargs['name']}
        return self._req(data=self.base)
    ...
    def template_create(self, *args, **kwargs):
        ...
        self.base['params'] = {
            "host": kwargs['name'],
            "groups":self.list_to_list(data=kwargs.get('groupid_list',[]),key="groupid"),
...
if __name__ == "__main__":
    F = _zabbix(host='http://zabbix-test.migang.com',timeout=15)
    F.login(user='admin',passwd='zabbix')
    F.timeout = 30                      #请求超时时间
    F.json = True                      #return json

    # print F.version()                 #查看api版本
